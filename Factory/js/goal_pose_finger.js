 ...
 */
class GoalPoseFinger extends Component {
    static TypeName = 'goal_pose_finger';
    static Properties = {
    ...
    start() {
        ...
        //this.socket = new WebSocket("ws://192.168.231.185:3000"); // On hotspot
    ...
    _teleportPlayer(newPosition, rotationToAdd) {
        ...
        this.socket.send(msgTxtIdentified); // Sends format {"0":x.xxx,"1":x.xxx,"2":x.xxx, "identifier":'goal_pose'}
    }

    selectRobot(robotId){
        //console.log("Switched goal robot to " + robotId)
        this.currentRobotNamespace = this.robotNamespaces[robotId-1];
    }
}
export { GoalPoseFinger };