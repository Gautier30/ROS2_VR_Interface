...
rclnodejs.init().then(() => {
    const node = rclnodejs.createNode('robot_goal_node');
    const publisher = node.createPublisher('geometry_msgs/msg/PoseStamped', '/goal_pose');
    ...
    socket.addEventListener("message", (event) => {
        ...
        if (msgParsed['identifier'] === 'goal_pose') {
