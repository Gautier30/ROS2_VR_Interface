...
declare module 'rclnodejs' {
  ...
  namespace jackal_msgs {
    namespace msg {
      export interface Drive {
        mode: number;
        drivers: number[] | Float32Array;
      }
      export interface DriveConstructor {
        readonly MODE_VELOCITY: number;
        readonly MODE_PWM: number;
        readonly MODE_EFFORT: number;
        readonly MODE_NONE: number;
        readonly LEFT: number;
        readonly RIGHT: number;
        new(other?: Drive): Drive;
      }
      export interface DriveFeedback {
        current: number;
        duty_cycle: number;
        bridge_temperature: number;
        motor_temperature: number;
        measured_velocity: number;
        measured_travel: number;
        driver_fault: boolean;
      }
      export interface DriveFeedbackConstructor {
        new(other?: DriveFeedback): DriveFeedback;
      }
      export interface Feedback {
        header: std_msgs.msg.Header;
        drivers: jackal_msgs.msg.DriveFeedback[];
        commanded_mode: number;
        actual_mode: number;
      }
      ...
      export interface Power {
        header: std_msgs.msg.Header;
        shore_power_connected: number;
        battery_connected: number;
        power_12v_user_nominal: number;
        charging_complete: number;
        measured_voltages: number[] | Float32Array;
        measured_currents: number[] | Float32Array;
      }
      export interface PowerConstructor {
        readonly NOT_APPLICABLE: number;
        readonly JACKAL_MEASURED_BATTERY: number;
        readonly JACKAL_MEASURED_5V: number;
        readonly JACKAL_MEASURED_12V: number;
        readonly JACKAL_TOTAL_CURRENT: number;
        readonly JACKAL_COMPUTER_CURRENT: number;
        readonly JACKAL_DRIVE_CURRENT: number;
        readonly JACKAL_USER_CURRENT: number;
        new(other?: Power): Power;
      }
      export interface Status {
        header: std_msgs.msg.Header;
        hardware_id: string;
        firmware_commit: string;
        mcu_uptime: builtin_interfaces.msg.Duration;
        connection_uptime: builtin_interfaces.msg.Duration;
    ...
    namespace srv {
      export interface SetDomainIdConstructor extends ROSService {
        readonly Request: SetDomainId_RequestConstructor;
        readonly Response: SetDomainId_ResponseConstructor;
      }
      export interface SetDomainId_Request {
        domain_id: number;
      }
      export interface SetDomainId_RequestConstructor {
        new(other?: SetDomainId_Request): SetDomainId_Request;
      }
      export interface SetDomainId_Response {
        success: boolean;
        message: string;
      }
      export interface SetDomainId_ResponseConstructor {
        new(other?: SetDomainId_Response): SetDomainId_Response;
      }
    }
  }
  ...
  type MessagesMap = {
    ...
    'jackal_msgs/msg/Drive': jackal_msgs.msg.Drive,
    'jackal_msgs/msg/DriveFeedback': jackal_msgs.msg.DriveFeedback,
    'jackal_msgs/msg/Feedback': jackal_msgs.msg.Feedback,
    'jackal_msgs/msg/Power': jackal_msgs.msg.Power,
    'jackal_msgs/msg/Status': jackal_msgs.msg.Status,
    'jackal_msgs/msg/StopStatus': jackal_msgs.msg.StopStatus,
    'jackal_msgs/srv/SetDomainId_Request': jackal_msgs.srv.SetDomainId_Request,
    'jackal_msgs/srv/SetDomainId_Response': jackal_msgs.srv.SetDomainId_Response,
  ...
  type MessageTypeClassConstructorMap = {
    ...
    'jackal_msgs/msg/Drive': jackal_msgs.msg.DriveConstructor,
    'jackal_msgs/msg/DriveFeedback': jackal_msgs.msg.DriveFeedbackConstructor,
    'jackal_msgs/msg/Feedback': jackal_msgs.msg.FeedbackConstructor,
    'jackal_msgs/msg/Power': jackal_msgs.msg.PowerConstructor,
    'jackal_msgs/msg/Status': jackal_msgs.msg.StatusConstructor,
    'jackal_msgs/msg/StopStatus': jackal_msgs.msg.StopStatusConstructor,
    'jackal_msgs/srv/SetDomainId_Request': jackal_msgs.srv.SetDomainId_RequestConstructor,
    'jackal_msgs/srv/SetDomainId_Response': jackal_msgs.srv.SetDomainId_ResponseConstructor,
  ...
  type ServicesMap = {
    ...
    'jackal_msgs/srv/SetDomainId': jackal_msgs.srv.SetDomainIdConstructor,
